...
class FilteringPlugin < WebBuddyPlugin
  ...
  def data
...

    {
      ...
      searches: 
        context_store.stacks.sort_by {|e| e.last_accessed_timestamp.to_s }.reverse.map do |stack|
          pages = stack.history_items.sort_by {|e| e.last_accessed_timestamp.to_s}.reverse
